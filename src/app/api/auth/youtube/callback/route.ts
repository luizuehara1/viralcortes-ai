...
export async function GET(req: NextRequest) {
  ...
  if (googleError) {
    return redirectWithError(req, `Autorização recusada pelo Google: ${googleError}`)
  }
  ...
  try {
    ...
    const res = NextResponse.redirect(new URL('/integrations?connected=youtube', req.url))
